...
func main() {
	...
	case "fill":
		...
		printResponse(showing.AddShowing(context.TODO(), &proto.ShowingData{Movie: "terminator", Cinema: "saal2"}))
		...
		printResponse(reservation.RequestReservation(context.TODO(), &proto.ReservationData{User: "sepp", Showing: 1, Seats: 15}))
		printResponse(reservation.RequestReservation(context.TODO(), &proto.ReservationData{User: "hans", Showing: 1, Seats: 20}))
